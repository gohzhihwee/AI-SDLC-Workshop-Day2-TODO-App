...
This repository contains the Todo App implementation together with its planning and reference documentation — `README.md`, `USER_GUIDE.md`, `EVALUATION.md`, `PRPs/*.md`, and `.github/copilot-instructions.md` describe the target behavior, while `app/`, `lib/`, `middleware.ts`, `package.json`, and `tests/` provide the implementation.
